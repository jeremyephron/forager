...
from setupbase import (build_frontend, find_package_data, find_package_deps,
                       find_package_dirs, find_packages)
...
annotating this data with user-defined tags.
    ...
    scripts=[
        ...
        "setupbase.py",
        "pyproject.toml",
        "forager_server/pyproject.toml",
        "forager_knn/pyproject.toml",
    ],
    extras_require={},
    python_requires=">=3.8",
    entry_points={
        "console_scripts": [
            "forager-server = forager.app:main",
        ]
    },
)
