...
urlpatterns = [
    ...
    path('api/get_datasets_v2',
         views.get_datasets_v2,
         name='get_datasets_v2'),
    ...
    path('api/add_annotations_multi_v2',
         views.add_annotations_multi_v2,
         name='add_annotations_multi_v2'),
    path('api/add_annotations_by_internal_identifiers_v2/<slug:dataset_name>',
         views.add_annotations_by_internal_identifiers_v2,
         name='add_annotations_by_internal_identifiers_v2'),
