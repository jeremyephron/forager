...
# VAL_EMBEDDINGS_FILE = "./waymo-val-r50/embeddings_res5.npy"
# VAL_IDENTIFIERS_FILE = Path("./waymo-val-r50/images.json")
# VAL_IDENTIFIERS = json.load(VAL_IDENTIFIERS_FILE.open())
# VAL_IDENTIFIERS = {
#     p[p.rfind("/") + 1 : p.rfind(".")]: i for i, p in enumerate(VAL_IDENTIFIERS)
# }
...
def get_svm_accuracy(vector_b64, model, val_identifiers, val_labels):
    ...
    # assert model == "imagenet"
    # embeddings = np.memmap(
    #     VAL_EMBEDDINGS_FILE,
    #     dtype="float32",
    #     mode="r",
    #     shape=(len(VAL_IDENTIFIERS), EMBEDDING_DIM),
    # )
